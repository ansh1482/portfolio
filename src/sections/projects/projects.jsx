            ...
            <div className="projects-content">
                <RaisedPanelWhite style={{padding: "10px", margin: "20px", flex: "0 0 25%"}}>
                    <PanelWhite style={{padding: "10px", marginBottom: "10px"}}>
                        <ScrollAnimation animateIn="fadeIn" duration={2}><h1>Quewer</h1></ScrollAnimation>
                    </PanelWhite>
                    <PanelWhite style={{padding: "10px", width: "fit-content", marginLeft: "5%", marginTop: "20px", borderRadius: "10px"}}>
                        <h3>Description:</h3>
                    </PanelWhite>
                    <ScrollAnimation animateIn="fadeIn" duration={2.5}><h4>Web based QnA application, designed for BITS Pilani, Hyderabad Campus students.</h4></ScrollAnimation>
                ...
                <RaisedPanelWhite style={{padding: "10px", margin: "20px", flex: "0 0 25%"}}>
                    <PanelWhite style={{padding: "10px", marginBottom: "10px"}}>
                        <ScrollAnimation animateIn="fadeIn" duration={2}><h1>MediChain</h1></ScrollAnimation>
                    </PanelWhite>
                    <PanelWhite style={{padding: "10px", width: "fit-content", marginLeft: "5%", marginTop: "20px", borderRadius: "10px"}}>
                        <h3>Description:</h3>
                    </PanelWhite>
                    <ScrollAnimation animateIn="fadeIn" duration={2.5}><h4>A Blockchain based app to speed up the registration process at hospitals.</h4></ScrollAnimation>
                ...
                <RaisedPanelWhite style={{padding: "10px", margin: "20px", flex: "0 0 25%"}}>
                    <PanelWhite style={{padding: "10px", marginBottom: "10px"}}>
                        <ScrollAnimation animateIn="fadeIn" duration={2}><h1>Cabbie</h1></ScrollAnimation>
                    </PanelWhite>
                    <PanelWhite style={{padding: "10px", width: "fit-content", marginLeft: "5%", marginTop: "20px", borderRadius: "10px"}}>
                        <h3>Description:</h3>
                    </PanelWhite>
                    <ScrollAnimation animateIn="fadeIn" duration={2.5}><h4>A Java based application to simulate the process of booking a cab.</h4></ScrollAnimation>
